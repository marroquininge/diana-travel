...
const destinos: Record<string, { nombre: string; descripcion: string; img: string; incluye: string[] }> = {
  amazonas: { nombre: "Amazonas", descripcion: "Sumérgete en la selva más grande del mundo. Una experiencia única de naturaleza, biodiversidad y cultura indígena que te cambiará la vida.", img: "/images/amazonas1.jpeg", incluye: ["Tiquetes aéreos", "Hospedaje en lodge", "Alimentación completa", "Guía especializado", "Excursiones por el río"] },
  ...
  covenas: { nombre: "Coveñas", descripcion: "Las playas más tranquilas del Caribe colombiano. Arena blanca, aguas cálidas y el mejor descanso en familia.", img: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&q=80", incluye: ["Transporte", "Hotel frente al mar", "Desayunos", "Paseo en lancha"] },
  ...
  europa: { nombre: "Europa", descripcion: "El viejo continente en un solo paquete. París, Roma, Madrid y más ciudades icónicas con toda la logística resuelta.", img: "https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=800&q=80", incluye: ["Tiquetes internacionales", "Hoteles", "Traslados entre ciudades", "Guía en español", "Seguro de viaje"] },
  ...
  "punta-cana": { nombre: "Punta Cana", descripcion: "República Dominicana en su máxima expresión. Playas paradisíacas, resorts de lujo y el mejor todo incluido del Caribe.", img: "https://images.unsplash.com/photo-1548574505-5e239809ee19?w=800&q=80", incluye: ["Tiquetes aéreos", "Resort todo incluido", "Traslados", "Excursión a Saona", "Seguro de viaje"] },
